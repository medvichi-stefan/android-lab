...
public class CameraActivity extends AppCompatActivity {
    ...
    private void getNextCameraId() {
        this.cameraId = -1;
        int numberOfCameras = Camera.getNumberOfCameras();
        int cameraType = this.cameraFront ? Camera.CameraInfo.CAMERA_FACING_FRONT : Camera.CameraInfo.CAMERA_FACING_BACK;
